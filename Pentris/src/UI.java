 ...
 */
public class UI extends javax.swing.JFrame implements Observer {

	
	// stuff is going wrong with rows and columns... remember: char[ROW][COL], not the other way around.
